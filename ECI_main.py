...
def objective(trial:optuna.Trial):
    params = {
        "bert_learning_rate": trial.suggest_categorical("b_lr", [5e-8, 1e-7, 5e-7, 1e-6, 5e-6, 1e-5, 5e-5]),
        "mlp_learning_rate": trial.suggest_categorical('mlp_lr', [1e-6, 5e-6, 1e-5, 5e-5]),
