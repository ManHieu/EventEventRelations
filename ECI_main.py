...
def objective(trial:optuna.Trial):
    params = {
        "bert_learning_rate": trial.suggest_categorical("b_lr", [5e-8, 8e-8, 1e-7, 3e-7, 5e-7, 8e-7, 1e-6]),
        "mlp_learning_rate":trial.suggest_categorical("m_lr", [1e-5, 3e-5, 5e-5, 8e-5, 1e-4]),
